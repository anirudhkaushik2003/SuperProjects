...
# define font
font = pygame.font.SysFont("Chilanka", 70)
font_score = pygame.font.SysFont("Chilanka", 30)
...
# load sounds
pygame.mixer.music.load("img/Spirited Away - Always With Me - 8Bit.wav")
    ...
    if main_menu == True:
        ...
        if game_over == 1:
            ...
            if level <= max_levels:
                ...
                draw_text(
                    "YOU WIN", font, blue, (screen_width // 2) - 140, screen_height // 2
                )
                if restart_button.draw():
                    level = 1
                    # reset level
