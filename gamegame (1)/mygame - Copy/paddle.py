...
class Paddle(Thing):
    ...
    def __init__(self, game_height, game_width, y=0):
        ...
        super().__init__(game_height, game_width, np.array([game_height - conf.GND_HEIGHT - 1, game_width/2]), np.array([1, 14]))
        self._acc = np.array([0, 0])
        self._repr = np.array([[' ', Fore.WHITE + Style.BRIGHT + '#', Fore.WHITE + '=',
                Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=',
                Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + Style.BRIGHT + '#', ' ']], dtype='object')
        self._repr_shield = np.array([[' ', Fore.WHITE + Style.BRIGHT + '#', Fore.WHITE + '=',
                Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '', Fore.WHITE + '',
                Fore.WHITE + '', Fore.WHITE + '', Fore.WHITE + Style.BRIGHT + '#', ' ']], dtype='object')
    ...
    def nudge(self, key):
        ...
        if key == 'a':
            ...
            self._repr = np.array([[' ', Fore.WHITE + Style.BRIGHT + '#', Fore.WHITE + '=',
                 Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '', Fore.WHITE + '',
                 Fore.WHITE + '', Fore.WHITE + '', Fore.WHITE + Style.BRIGHT + '#', ' ']], dtype='object')
            self.shield_condition = True
            
        elif key == 'f':

            self._repr = np.array([[ Fore.WHITE + Style.BRIGHT + '#', Fore.WHITE + '=',Fore.WHITE + '=',Fore.WHITE + '=',
                Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + '=',
                Fore.WHITE + '=', Fore.WHITE + '=', Fore.WHITE + Style.BRIGHT + '#']], dtype='object')
            self.shield_condition2 = True          
